...
<div class="bg-black border-right" id="sidebar-wrapper">
  ...
  <div class="list-group list-group-flush " ALIGN=center>
    <a href="../subcategorias/subcategorias.php" class="list-group-item list-group-item-action bg-dark text-white " >Volver</a>
...
<?php
 ...
 $sql = "insert into subcategorias(
  nombre_subcategoria,activo_subcategoria)
  values" 
  . "('".$_POST['nombre_subcategoria'] 	. "'," 
  . "'" .$_POST['activo_subcategoria'] 	. "' "	
  . ")";

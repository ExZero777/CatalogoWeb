      ...
      <div class="list-group list-group-flush">
        <a href="#pageSubmenu" data-toggle="collapse" aria-expanded="true" class="list-group-item list-group-item-action dropdown-toggle bg-dark text-white">Listado Por Categorias</a>
            <ul class="in list-unstyled" id="pageSubmenu">
                ...
                <li>
                  <a href="../mlibs/ordencatza2.php" class="list-group-item list-group-item-action bg-warning text-dark">Z-A</a>
                </li>
                <li>
                  <a href="../mlibs/ordencataz2.php" class="list-group-item list-group-item-action bg-warning text-dark">A-Z</a>
                </li>
            </ul>         
  ...
  <div id="page-content-wrapper align-self-center" >
    ...
    <div class="mt-4 align-self-center text-left">
      ...
      ?>
        ...
        <a 	<?php echo "href=../listados2/subcategorias.php?id_categoria=".$categorias[$i]['id_categoria'];?>

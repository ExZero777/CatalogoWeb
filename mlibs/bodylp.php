    ...
    <div class="sidebar-heading bg-black text-dark">Menú de Opciones</div>
      ...
      <a href="#pageSubmenu" data-toggle="collapse" aria-expanded="true" class="list-group-item list-group-item-action dropdown-toggle bg-dark text-white">Listado De Productos</a>
            <ul class="in list-unstyled" id="pageSubmenu">
                ...
                <li>
                  <a href="../mlibs/ordenpza.php" class="list-group-item list-group-item-action bg-warning text-dark">Z-A</a>
                </li>
                <li>
                  <a href="../mlibs/ordenpaz.php" class="list-group-item list-group-item-action bg-warning text-dark">A-Z</a>
                </li>
                <li>
                  <a href="../mlibs/ordenpr.php" class="list-group-item list-group-item-action bg-warning text-dark">Ranqueados</a>
                </li>
                <li>
                  <a href="../mlibs/ordenpdes.php" class="list-group-item list-group-item-action bg-warning text-dark">Destacados</a>
                </li>
            </ul>         

...
<div class="container">
    <div class="d-flex justify-content-center text-dark">
      <form ALIGN=center class="form-horizontal" action="../marcas/modi.php" method="POST">
        <div class="form-group">

           
        <div class="col-md-12 mb-4">
          
            <input type="hidden" class="form-control" name="id_marca" placeholder="" value=<?php echo "'".$marcas[0]['id_marca']."'" ?> required>
          ...
          <div class="col-md-12 mb-4">
            ...
            <input type="text" class="form-control" name="nombre_marca" placeholder="" value=<?php echo "'".$marcas[0]['nombre_marca']."'" ?> required>
            <div class="invalid-feedback">
          ...
          <div class="col-md-12 mb-4">
            ...
            <select type="text" class="custom-select d-block w-100" name="activo_marca" placeholder="" value=<?php echo "'".$marcas[0]['activo_marca']."'" ?> required>
